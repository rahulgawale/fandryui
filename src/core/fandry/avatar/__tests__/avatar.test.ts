...
describe('fandry-avatar', () => {
  ...
  it('renders with the default "md" size class', () => {
    const element = createElement('fandry-avatar', { is: FdAvatar });
  ...
  it('retries the image after a failure once src changes', () => {
    const element = createElement('fandry-avatar', { is: FdAvatar }) as FdAvatar & HTMLElement;
    element.src = 'https://example.com/broken.jpg';
    element.initials = 'JD';
    document.body.appendChild(element);
